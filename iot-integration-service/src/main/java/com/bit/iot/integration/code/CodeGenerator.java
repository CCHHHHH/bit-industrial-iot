package com.bit.iot.integration.code;
...
public class CodeGenerator {
    public static void main(String[] args) {
        ...
        //数据库表的设置
        List<String> listTable = Arrays.asList("integration_config_param");  // 设置需要自动代码生成的表名
...
//        List<String> listTablePrefix = Arrays.asList("fmea_"); //设置 过滤 表的前缀
        ...
        String parent = "com.bit.iot.integration";   // 父包名
...
//                            .other("config")    //自定义包名(一般不在这里生成，而是后面编写的时候自己建包)
                            .pathInfo(Collections.singletonMap(OutputFile.xml, System.getProperty("user.dir") + "/src/main/resources/mapper/com/bit/iot/integration"));    // 配置 mapper.xml 路径信息：项目的 resources 目录下
                })
                //4、策略配置
